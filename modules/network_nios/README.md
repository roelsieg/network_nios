# Taken from the Community general Collection #######################

## network.nios
This readme commes from the original repo git@github.com:ansible-collections/community.general.git
Since we forked only the NIOS modules for usage within our project we have renamed the repo in the "galaxy.yml" to :
...
We've replaced all occurances of 'community.general' with 'network.nios' to support the usage of the module in our own repo.

## Adjustments

The "plugins\lookup\nios_next_network.py" is lacking functionality to work with views.
This can be adjusted by using this private bitbucket repository.
