...
- name: Configure ipv4 dhcp fixed address
  network.nios.nios_fixed_address:
    name: ipv4_fixed
    ipaddr: 192.168.10.1
...
from ansible_collections.network.nios.plugins.module_utils.net_tools.nios.api import NIOS_IPV4_FIXED_ADDRESS, NIOS_IPV6_FIXED_ADDRESS
